...
//        System.out.println("Max value found:" + max);
        ...
        NoRandomArrayAction action = new NoRandomArrayAction(data, 0, data.length - 1, data.length / 16);
        
        pool.invoke(action);
        
        NoFindMaxTask task = new NoFindMaxTask(data, 0, data.length-1, data.length/16);
