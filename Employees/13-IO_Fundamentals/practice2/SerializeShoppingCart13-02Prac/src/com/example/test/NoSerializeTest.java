...
import com.example.domain.NoItem;
import com.example.domain.NoShoppingCart;
...
public class NoSerializeTest {
    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader in = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            cart = new NoShoppingCart(new Integer(cartId).intValue());
        } catch (IOException | NumberFormatException e) { // Catch any exceptions.
            System.out.println("Exception: " + e);
            System.exit(-1);
        }
        // Add some items
        cart.addItem(new NoItem(101, "Duke Plastic Circular Flying Disc", 10.95));
        cart.addItem(new NoItem(123, "Duke Soccer Pro Soccer ball", 29.95));
        cart.addItem(new NoItem(45, "Duke \"The Edge\" Tennis Balls - 12-Ball Bag", 17.49));
