...
public class NoDepartArrive {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Local time BOS at departure: " + departBOS);
    ...
    ZonedDateTime arriveSFO = arriveBOS.toOffsetDateTime().atZoneSameInstant(SFO);
    arriveSFO = arriveBLR.toOffsetDateTime().atZoneSameInstant(SFO);
    System.out.println("Local time SFO at arrival:   " + arriveSFO + "\n");
    ...
    departSFO = ZonedDateTime.of(departure, SFO);
    System.out.println("Flight 123 departs SFO at:   " + departSFO);
    departBOS = departSFO.toOffsetDateTime().atZoneSameInstant(BOS);
    System.out.println("Local time BOS at departure: " + departBOS);
    System.out.println("Flight time: 5 hours 30 minutes");
    arriveBOS = departSFO.plusHours(5).plusMinutes(30).toOffsetDateTime().atZoneSameInstant(BOS);
    System.out.println("Flight 123 arrives BOS:      " + arriveBOS);
    arriveSFO = arriveBOS.toOffsetDateTime().atZoneSameInstant(SFO);
    System.out.println("Local time SFO at arrival:   " + arriveSFO);
  }
